  ...
  return (
    <section id="contact" className="w-full flex flex-col items-center justify-center py-20 bg-gray-900/80">
      ...
      <div className="flex gap-10">
        ...
        {/* Email */}
        <a
          href="mailto:sahil.india1993@gmail.com"
          className="text-gray-100 hover:text-blue-400 transition-colors duration-200"
          aria-label="Email"
        >
          <svg className="w-12 h-12" fill="currentColor" viewBox="0 0 24 24">
            <path d="M2.01 6.81A2.75 2.75 0 0 1 4.75 5h14.5c.69 0 1.32.26 1.8.69l-9.05 7.13a.75.75 0 0 1-.9 0L2.01 6.81zm-.01 2.13v8.31A2.75 2.75 0 0 0 4.75 20h14.5A2.75 2.75 0 0 0 22 17.25V8.94l-8.34 6.57a2.25 2.25 0 0 1-2.72 0L2 8.94z" />
          </svg>
        </a>
        {/* Phone */}
        <a
          href="tel:+917503247437"
